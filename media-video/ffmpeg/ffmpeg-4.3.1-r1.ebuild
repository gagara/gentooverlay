...
FFMPEG_FLAG_MAP=(
		...
		libaribb24 mmal rkmpp modplug:libmodplug opus:libopus libilbc librtmp ssh:libssh
		...
		+threads:pthreads
		# others: avisynth libmysofa libshine omx
		libopenmpt
)
...
RDEPEND="
	...
	libopenmpt? ( media-libs/libopenmpt:=[${MULTILIB_USEDEP}] )
